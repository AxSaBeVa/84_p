...
function my_keydown(e)
{
	...
	console.log(keyPressed);
		...
		aplhabetkey();
		document.getElementById("d1").innerHTML="presionaste una tecla de alfabeto";
		console.log("alphabet key");
		}
	else {
		otherkey();
		document.getElementById("d1").innerHTML="presionaste una tecla de simbolo u otra tecla";
	}
}
